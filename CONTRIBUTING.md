Contributing to SkyHub Core
============================

The SkyHub Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SkyHub Core project, and is not to be
confused with overall SkyHub Network Protocol consensus changes.

Whether a pull request is merged into SkyHub Core rests with the project merge
...
Patches that change SkyHub consensus rules are considerably more involved than
...
Where a patch set proposes to change the SkyHub consensus, it must have been
...
The project leader is the release manager for each SkyHub Core release.
