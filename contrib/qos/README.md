...
This means one can have an always-on skyhubd instance running, and another local skyhubd/skyhub-qt instance which connects to this node and receives blocks from it.
