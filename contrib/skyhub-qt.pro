...
RESOURCES += src/qt/skyhub.qrc src/qt/skyhub_locale.qrc

TRANSLATIONS += src/qt/locale/skyhub_bg.ts \
                src/qt/locale/skyhub_de.ts \
                src/qt/locale/skyhub_en.ts \
                src/qt/locale/skyhub_es.ts \
                src/qt/locale/skyhub_fi.ts \
                src/qt/locale/skyhub_fr.ts \
                src/qt/locale/skyhub_it.ts \
                src/qt/locale/skyhub_ja.ts \
                src/qt/locale/skyhub_pl.ts \
                src/qt/locale/skyhub_pt.ts \
                src/qt/locale/skyhub_ru.ts \
                src/qt/locale/skyhub_sk.ts \
                src/qt/locale/skyhub_sv.ts \
                src/qt/locale/skyhub_vi.ts \
                src/qt/locale/skyhub_zh_CN.ts \
                src/qt/locale/skyhub_zh_TW.ts
