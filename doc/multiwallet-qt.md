...
In order to support loading of multiple wallets in skyhub-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is skyhub.cpp.
...
Changes to skyhub.cpp
----------------------
skyhub.cpp is the entry point into skyhub-qt, and as such, will require some minor modifications to provide hooks for
