SkyHub Core version 2.2.1 is now available from:

  <https://github.com/skyhub-project/skyhub/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/skyhub-project/skyhub/issues>

Compatibility
==============

SkyHub Core is extensively tested on multiple operating systems using
...
SkyHub Core should also work on most other Unix-like systems but is not
...
of Bitcoin that SkyHub was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/skyhub-project-translations/).
