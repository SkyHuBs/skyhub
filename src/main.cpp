...
#if defined(NDEBUG)
#error "SkyHub cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 60 * 60 * 5;
...
int64_t GetBlockValue(int nHeight)
{
	...
	nSubsidy = 1 * COIN;
        } else if (nHeight <= 9999 && nHeight > 0) {
        nSubsidy = 0.5 * COIN;
        } else if (nHeight <= 19999 && nHeight > 9999) {
        nSubsidy = 0.6 * COIN;
	} else if (nHeight <= 29999 && nHeight > 19999) {
        nSubsidy = 0.7 * COIN;
	} else if (nHeight <= 39999 && nHeight > 29999) {
        nSubsidy = 0.8 * COIN;
	} else if (nHeight <= 49999 && nHeight > 39999) {
        nSubsidy = 0.9 * COIN;
	} else if (nHeight <= 59999 && nHeight > 49999) {
        nSubsidy = 1.0 * COIN;
	} else if (nHeight <= 69999 && nHeight > 59999) {
        nSubsidy = 1.1 * COIN;
	} else if (nHeight <= 79999 && nHeight > 69999) {
        nSubsidy = 1.2 * COIN;
	} else if (nHeight <= 89999 && nHeight > 79999) {
        nSubsidy = 1.3 * COIN;
	} else if (nHeight <= 99999 && nHeight > 89999) {
        nSubsidy = 1.4 * COIN;
	} else if (nHeight <= 109999 && nHeight > 99999) {
        nSubsidy = 1.5 * COIN;
	} else if (nHeight <= 119999 && nHeight > 109999) {
        nSubsidy = 1.4 * COIN;
	} else if (nHeight <= 129999 && nHeight > 119999) {
        nSubsidy = 1.3 * COIN;
	} else if (nHeight <= 139999 && nHeight > 129999) {
        nSubsidy = 1.2 * COIN;
	} else if (nHeight <= 149999 && nHeight > 139999) {
        nSubsidy = 1.1 * COIN;
	} else if (nHeight <= 159999 && nHeight > 149999) {
        nSubsidy = 1.0 * COIN;
	} else if (nHeight <= 169999 && nHeight > 159999) {
        nSubsidy = 0.9 * COIN;
	} else if (nHeight <= 179999 && nHeight > 169999) {
        nSubsidy = 0.8 * COIN;
	} else if (nHeight <= 189999 && nHeight > 179999) {
        nSubsidy = 0.7 * COIN;
	} else if (nHeight <= 199999 && nHeight > 189999) {
        nSubsidy = 0.6 * COIN;
	} else if (nHeight <= 9800248 && nHeight > 199999) {
        nSubsidy = 0.5 * COIN;
    } else {
        nSubsidy = 0 * COIN;
    }
