                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SkyHub Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SkyHub address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and skyhub: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SkyHub Core"), this);
    aboutAction->setStatusTip(tr("Show information about SkyHub Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SkyHub"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SkyHub addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SkyHub addresses"));
    ...
    openAction->setStatusTip(tr("Open a SkyHub: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SkyHub Core help message to get a list with possible SkyHub command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SkyHub Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SkyHub network", "", count));
}
...
{
    QString strTitle = tr("SkyHub Core"); // default title
