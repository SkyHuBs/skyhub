...
/** Utility functions used by the SkyHub Qt UI.
 */
namespace GUIUtil
{
...
// Render SkyHub addresses in monospace font
...
// Parse "skyhub:" URI into recipient object, return true on successful parsing
