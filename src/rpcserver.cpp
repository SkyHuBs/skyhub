...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SkyHub features */
        {"skyhub", "masternode", &masternode, true, true, false},
        {"skyhub", "masternodelist", &masternodelist, true, true, false},
        {"skyhub", "mnbudget", &mnbudget, true, true, false},
        {"skyhub", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"skyhub", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"skyhub", "mnsync", &mnsync, true, true, false},
        {"skyhub", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"skyhub", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use skyhubd, or the -server option to skyhub-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> skyhub-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:25011/\n";
}
