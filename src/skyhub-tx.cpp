...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SkyHub Core skyhub-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  skyhub-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded skyhub transaction") + "\n" +
                               "  skyhub-tx [options] -create [commands]   " + _("Create hex-encoded skyhub transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded skyhub transaction
